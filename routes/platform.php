...
Route::screen('post', \App\Orchid\Screens\PostEditScreen::class)
    ->name('platform.post.edit');

Route::screen('posts', \App\Orchid\Screens\PostListScreen::class)
    ->name('platform.post.list');

Route::screen('grant-access', \App\Orchid\Screens\GrantAccessSecreen::class)->name('platform.grant-access');

Route::screen('clients', \App\Orchid\Screens\Client\ClientListScreen::class)->name('platform.client.list');

Route::screen('client/{client?}', \App\Orchid\Screens\Client\ClientEditScreen::class)
    ->name('platform.client.edit');

Route::middleware('checkAccessTokenValidity')->group(function () {

    Route::screen('products', \App\Orchid\Screens\Product\ProductScreen::class)->name('platform.product.list');
